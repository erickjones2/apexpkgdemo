...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1435893168402075839)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
,p_version_scn=>16973703
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1472095656704645590)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1435893966868075841)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1435897962478117664)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(982467658003968332)
...
,p_list_item_disp_cond_type=>'CURRENT_PAGE_NOT_IN_CONDITION'
,p_list_item_disp_condition=>'1000'
,p_parent_list_item_id=>wwv_flow_imp.id(1435897962478117664)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1435893386119075840)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1018183450653368655)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1018185781513379673)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1435894230439075841)
