...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(5580179187027286590)
,p_name=>'Manage Repository'
,p_list_status=>'PUBLIC'
,p_version_scn=>16973703
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5580180290937286595)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5580180572218286595)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(5580179970798286595)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3799738957127503354)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3799758134402506236)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3799777342713508700)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4101853529545299996)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2517324839893936770)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2726012658152700741)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1955847913862194986)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4498087935720781090)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2509239456425508793)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2506149855734826791)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1821813769077228308)
