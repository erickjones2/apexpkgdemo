prompt --application/shared_components/legacy_data_loads/eba_bt_sw_defects
begin
--   Manifest
--     EBA_BT_SW_DEFECTS
--   Manifest End
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(4393975136756521238)
,p_name=>'Upload Bugs'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393975449664521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393977253256521250)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393977059337521249)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393976836043521249)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393976644688521249)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393976441217521249)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393976240568521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393976030883521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393975841240521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393975630345521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(4393975259678521248)
,p_load_table_id=>wwv_flow_imp.id(4393975136756521238)
