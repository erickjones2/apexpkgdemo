...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2647290935645401483)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2297573863220898683)
,p_plugin_id=>wwv_flow_imp.id(2647290935645401483)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2297574307504898683)
,p_plugin_id=>wwv_flow_imp.id(2647290935645401483)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(855234279059774516)
,p_plugin_id=>wwv_flow_imp.id(2647290935645401483)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2297575249626898685)
,p_plugin_id=>wwv_flow_imp.id(2647290935645401483)
