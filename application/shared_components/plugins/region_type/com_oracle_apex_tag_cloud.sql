...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(6509602392123272055)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2331213518796039760)
,p_plugin_id=>wwv_flow_imp.id(6509602392123272055)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2331213928335039761)
,p_plugin_id=>wwv_flow_imp.id(6509602392123272055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2331214311096039761)
,p_plugin_id=>wwv_flow_imp.id(6509602392123272055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(855234758533774524)
,p_plugin_id=>wwv_flow_imp.id(6509602392123272055)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2331215594345039792)
,p_plugin_id=>wwv_flow_imp.id(6509602392123272055)
