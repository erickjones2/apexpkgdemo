...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1310789691812313534)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2622492959612957704)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2622493349981957706)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1310789691812313534)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2622493136321957705)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2622494338975957717)
,p_branch_action=>'f?p=&APP_ID.:&LAST_VIEW.:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(2622493349981957706)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2622493552661957706)
,p_name=>'P28_USERNAME_FORMAT'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2622492959612957704)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2622494057041957714)
...
,p_process_when_button_id=>wwv_flow_imp.id(2622493349981957706)
,p_process_success_message=>'Username format updated.'
,p_internal_uid=>2622494057041957714
);
