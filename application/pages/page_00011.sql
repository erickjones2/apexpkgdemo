...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2506139132441816858)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2506139329780816858)
,p_name=>'Report 1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139452177816859)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139553917816860)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139655088816860)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139747227816860)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139845196816861)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506139955319816861)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2506140059746816861)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2506140136927816861)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2509248337292647903)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2506139132441816858)
