...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16742377851334865)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16743429607350830)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(16742377851334865)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16743816827353784)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(36712493964832610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16742754284338202)
,p_name=>'P79_PRODUCT_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16742377851334865)
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16744816053374616)
,p_name=>'P79_MODE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(16742377851334865)
...
,p_lov=>'.'||wwv_flow_imp.id(16745177846378359)||'.'
,p_grid_label_column_span=>4
,p_field_template=>wwv_flow_imp.id(1225704860700288343)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1103713935178490330)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103714258381490333)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103714891225490339)
,p_event_id=>wwv_flow_imp.id(1103714258381490333)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103714463739490335)
,p_event_id=>wwv_flow_imp.id(1103714258381490333)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103714343612490334)
,p_event_id=>wwv_flow_imp.id(1103714258381490333)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(314224332604918135)
,p_name=>'CNX'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16743429607350830)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(314224490616918136)
,p_event_id=>wwv_flow_imp.id(314224332604918135)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16743187324346840)
...
,p_process_when_button_id=>wwv_flow_imp.id(16743816827353784)
,p_process_success_message=>'Action Processed'
,p_internal_uid=>16743187324346840
);
