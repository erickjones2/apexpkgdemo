...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16603387620134807048)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1456538911134607270)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(16603387620134807048)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1456540978581607315)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1456539326169607276)
,p_name=>'P96_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(16603387620134807048)
,p_item_default=>'null'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1456539974914607312)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1456540475712607314)
,p_event_id=>wwv_flow_imp.id(1456539974914607312)
,p_event_result=>'TRUE'
