...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2509237240042498170)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2509237437290498171)
,p_name=>'Assignee Groups'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509237541357498172)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509237658077498172)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509237754890498172)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509237843704498172)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2509238543507498298)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(314224090609918132)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2509237240042498170)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2509238032502498172)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103933619243445553)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103934020288445554)
,p_event_id=>wwv_flow_imp.id(1103933619243445553)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2509237240042498170)
);
