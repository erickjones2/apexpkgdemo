...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2622500942999984094)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2622501541400984098)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2622502735472984101)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2622501142533984096)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2622500942999984094)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2622501335566984098)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1103797424038068159)
,p_branch_name=>'next'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2622501756936984098)
,p_name=>'P83_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2622501541400984098)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2622501932238984099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2622502932837984102)
,p_name=>'P83_USERNAME_FORMAT1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2622502735472984101)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2622503548235984103)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103796769674068153)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2622501142533984096)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103796862124068154)
,p_event_id=>wwv_flow_imp.id(1103796769674068153)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2622503657163984103)
...
,p_process_when_button_id=>wwv_flow_imp.id(2622501335566984098)
,p_internal_uid=>2622503657163984103
);
