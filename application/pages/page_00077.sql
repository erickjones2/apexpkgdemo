...
,p_group_id=>wwv_flow_imp.id(2506141828975820570)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2055755436056910534)
,p_name=>'&APPLICATION_TITLE.'
,p_template=>wwv_flow_imp.id(1235076342164147026)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2055755582202910535)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2055755639936910536)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2055755783876910537)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4415556945120507096)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2624256344237490923)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_imp.id(4415556945120507096)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2624256727746495630)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2624256932594496997)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2624257137442498386)
,p_plug_name=>'Support'
,p_parent_plug_id=>wwv_flow_imp.id(4415556945120507096)
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(1225683798473288318)
