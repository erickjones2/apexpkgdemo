...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(37895305511641955)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38160637572541299)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_03', 'f?p=&APP_ID.:86:&APP_SESSION.::&DEBUG.:86,RIR,RP:P86_PRODUCT:&ID.',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '50',
  'attribute_15', 'TEXT',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'INITIALS',
  'attribute_02', 'LOGIN_NAME',
  'attribute_03', 'f?p=&APP_ID.:86:&APP_SESSION.::&DEBUG.:86,RIR,RP:P86_PRODUCT,IR_SUBMITTED_BY_ID:&P80_PRODUCT.,&SID.',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '50',
  'attribute_15', 'TEXT',
  ...
  'attribute_17', 'MODERN',
  'attribute_18', 'ABOVE',
  'attribute_20', 'No filers found.')).to_clob
,p_plug_comment=>' style="height: 208px; overflow: hidden;" data-grid="col_2" data-grid-start="yes"  '
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38166848036738268)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'INITIALS',
  'attribute_02', 'FILING_MONTH',
  'attribute_03', 'f?p=&APP_ID.:86:&APP_SESSION.::&DEBUG.:86,RIR,RP:P86_PRODUCT,IR_FILE_MONTH:&P90_PRODUCT.,&FILING_MONTH.',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '500',
  'attribute_15', 'TEXT',
  ...
  'attribute_17', 'MODERN',
  'attribute_18', 'ABOVE',
  'attribute_20', 'No filed enhancements found.')).to_clob
,p_plug_comment=>' style="height: 208px; overflow: hidden;" data-grid="col_2" data-grid-start="yes"  '
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38167736437753075)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38743347846247501)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_17', 'MODERN',
  'attribute_18', 'ABOVE',
  'attribute_20', 'No severities found.')).to_clob
,p_plug_comment=>' style="height: 208px; overflow: hidden;" data-grid="col_2" data-grid-start="yes"  '
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38160971312541303)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(38160637572541299)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38164789450657634)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(38164440273657633)
,p_button_name=>'VIEW_assignees'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--noUI'
,p_button_template_id=>wwv_flow_imp.id(1225705056775288345)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38168068591753077)
,p_name=>'P90_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38167736437753075)
,p_prompt=>'Product'
