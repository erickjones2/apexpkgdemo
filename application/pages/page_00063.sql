...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16723930398000004)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16727109317025833)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(236824109651648234)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(332495869603100148)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16724928869004959)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(332495869603100148)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16725839602017801)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(33593801578808069)
,p_branch_name=>'back'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16727835609031317)
,p_name=>'P63_MINIMUM_DATE'
,p_item_sequence=>45
,p_item_plug_id=>wwv_flow_imp.id(16727109317025833)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16728234129031317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16733886152142720)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16737970928180354)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16762440027579918)
,p_name=>'P63_OFFSET'
,p_item_sequence=>75
,p_item_plug_id=>wwv_flow_imp.id(16727109317025833)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(941698516579969850)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(992747900380451613)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(332495977212100149)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16724928869004959)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(332496125802100150)
,p_event_id=>wwv_flow_imp.id(332495977212100149)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(941698387915969849)
...
,p_internal_uid=>941698387915969849
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16736743822165884)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(16725839602017801)
,p_process_success_message=>'New Product Synconized'
,p_internal_uid=>16736743822165884
);
