...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1310789793223313535)
...
,p_plug_required_role=>wwv_flow_imp.id(3797358846252064904)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2439627644936485874)
...
,p_plug_template=>wwv_flow_imp.id(1233751870134533188)
...
,p_plug_query_row_template=>wwv_flow_imp.id(8719114279383182117)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2719974147076648813)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(314224608218918137)
,p_plug_name=>'ACL Info'
,p_parent_plug_id=>wwv_flow_imp.id(2719974147076648813)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(314224649709918138)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_imp.id(2719974147076648813)
...
,p_query_row_template=>wwv_flow_imp.id(1225693260953288328)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(314224746935918139)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(314224854359918140)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(314224977496918141)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1310789584789313533)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_06', 'eba_bt_fw.get_preference_value(''ACCESS_CONTROL_SCOPE'')',
  'attribute_07', 'eba_bt_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'')')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3801679353308776668)
...
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(3801644142226773463)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(1225701339428288338)
,p_plug_required_role=>wwv_flow_imp.id(3797358846252064904)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4522798135789485073)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(4522797632230485069)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(1225701339428288338)
,p_plug_required_role=>wwv_flow_imp.id(3797358846252064904)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5580176564124251581)
,p_plug_name=>'Application Administration'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>wwv_flow_imp.id(1225690169574288324)
,p_plug_display_sequence=>10
,p_list_id=>wwv_flow_imp.id(5580179187027286590)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(1225701339428288338)
,p_plug_required_role=>wwv_flow_imp.id(3797358846252064904)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2439627931215491414)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2439627644936485874)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2439628144375495191)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(4400424332660864820)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825328733967837868)
...
,p_internal_uid=>3825328733967837868
);
