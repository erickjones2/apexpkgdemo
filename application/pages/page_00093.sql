...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(938549607197779326)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(938549719137779327)
...
,p_plug_template=>wwv_flow_imp.id(1225686614700288321)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7236345825883373388)
,p_plug_name=>'Bug'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(937809803058804328)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(938549607197779326)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(937811016535804332)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(937817879079804349)
...
,p_branch_when_button_id=>wwv_flow_imp.id(937811016535804332)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937782133816804260)
,p_name=>'P93_ID'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(7236345825883373388)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937782565521804267)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937783523461804271)
,p_name=>'P93_SUBJECT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(7236345825883373388)
,p_use_cache_before_default=>'NO'
...
,p_cSize=>80
,p_cMaxlength=>255
,p_field_template=>wwv_flow_imp.id(1593548698177354147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937784416166804272)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937785284468804274)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937786185740804275)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937787055910804277)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937788247809804278)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937799525414804289)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937800353374804290)
,p_name=>'P93_SEVERITY_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(938549719137779327)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Severity'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937801241337804291)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937802150768804292)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937804861524804295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937805802048804296)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937806648988804297)
,p_name=>'P93_OS_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(938549719137779327)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937807609460804298)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937808486985804299)
,p_name=>'P93_TAGS'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(938549719137779327)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(937809383085804301)
,p_name=>'P93_CUSTOMER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(938549719137779327)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(937811832850804338)
...
,p_associated_item=>wwv_flow_imp.id(937783523461804271)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(937812264105804338)
...
,p_associated_item=>wwv_flow_imp.id(937787055910804277)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(937811456085804336)
...
,p_validation_condition2=>'0'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_imp.id(937805802048804296)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(937814539225804342)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(937815075117804344)
,p_event_id=>wwv_flow_imp.id(937814539225804342)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(937815603593804345)
,p_event_id=>wwv_flow_imp.id(937814539225804342)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(937815985246804345)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(937816521152804346)
,p_event_id=>wwv_flow_imp.id(937815985246804345)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(937816962310804346)
,p_event_id=>wwv_flow_imp.id(937815985246804345)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(384056021597709634)
,p_name=>'Cancel DIalog'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(937809803058804328)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(384056109999709635)
,p_event_id=>wwv_flow_imp.id(384056021597709634)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(937813332843804340)
...
,p_internal_uid=>937813332843804340
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(937812991660804340)
...
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>937812991660804340
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(937812593126804339)
...
,p_process_clob_language=>'PLSQL'
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>937812593126804339
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(937813801599804340)
...
,p_process_when_button_id=>wwv_flow_imp.id(937811016535804332)
,p_process_success_message=>'Bug Created'
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>937813801599804340
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(937814211192804341)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_internal_uid=>937814211192804341
);
