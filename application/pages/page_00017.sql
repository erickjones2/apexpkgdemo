...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1096898811888896353)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10379396304843994567)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6332826592758744379)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1096898811888896353)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379397398371994576)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379396977237994574)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379397189591994576)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1096900608509896471)
,p_branch_name=>'Go back to all prodcuts'
,p_branch_action=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(10379397189591994576)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1421057518386855595)
,p_name=>'P17_EXTERNAL_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(10379396304843994567)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1421079003156869756)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379397996535994577)
,p_name=>'P17_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10379396304843994567)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379398204602994578)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379398400223994578)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379398791699994579)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379398998026994579)
,p_name=>'P17_REQUEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(10379396304843994567)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379399400642994580)
,p_name=>'P17_POPUPURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(10379396304843994567)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10383478979098967695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10383830081596574001)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10379399806069994582)
...
,p_associated_item=>wwv_flow_imp.id(10379398204602994578)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2784302859176037425)
...
,p_when_button_pressed=>wwv_flow_imp.id(10379397189591994576)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1096898845990896354)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10379396977237994574)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1096898935855896355)
,p_event_id=>wwv_flow_imp.id(1096898845990896354)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6332825006826738910)
...
,p_security_scheme=>wwv_flow_imp.id(3797358846252064904)
,p_internal_uid=>6332825006826738910
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1096899114785896356)
...
,p_internal_uid=>1096899114785896356
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6332821785570723310)
...
,p_attribute_04=>'ID'
,p_attribute_11=>'I:U:D'
,p_internal_uid=>6332821785570723310
);
