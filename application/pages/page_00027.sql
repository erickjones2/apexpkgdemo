...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10436918293168788471)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10436918687144788477)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10436918489809788475)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10436918905725788477)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(10436922504767788516)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6323645687653232381)
,p_name=>'P27_DETAIL_TYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(10436918293168788471)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436919302130788478)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436919497168788488)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436919700533788488)
,p_name=>'P27_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10436918293168788471)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436920094330788489)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436920491569788489)
,p_name=>'P27_REQUEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(10436918293168788471)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436920699279788490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436920902345788490)
,p_name=>'P27_NOTES'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(10436918293168788471)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10436921100099788490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10437446506615841589)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10437478703115887804)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10436921879926788507)
...
,p_internal_uid=>10436921879926788507
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10436922099924788513)
...
,p_attribute_04=>'10'
,p_process_when_button_id=>wwv_flow_imp.id(10436918489809788475)
,p_internal_uid=>10436922099924788513
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10436922282408788515)
...
'END ;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(10436918905725788477)
,p_process_success_message=>'Record Inserted'
,p_internal_uid=>10436922282408788515
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6323651501346349802)
...
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(10436918489809788475)
,p_internal_uid=>6323651501346349802
);
