...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1062937646106761726)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1062937749800761727)
,p_region_id=>wwv_flow_imp.id(1062937646106761726)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1062937891671761728)
,p_chart_id=>wwv_flow_imp.id(1062937749800761727)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062938058478761730)
,p_chart_id=>wwv_flow_imp.id(1062937749800761727)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Bug Count'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062937990325761729)
,p_chart_id=>wwv_flow_imp.id(1062937749800761727)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Developer'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1062938139888761731)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1062938251679761732)
,p_region_id=>wwv_flow_imp.id(1062938139888761731)
,p_chart_type=>'bar'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1062938403152761733)
,p_chart_id=>wwv_flow_imp.id(1062938251679761732)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062938493333761734)
,p_chart_id=>wwv_flow_imp.id(1062938251679761732)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Developer'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062938556614761735)
,p_chart_id=>wwv_flow_imp.id(1062938251679761732)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Bug Count'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1347824220131080131)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6366378574706931565)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1342799454256958262)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6366378574706931565)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6366381981571931576)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6366382203913931576)
,p_branch_action=>'f?p=&FLOW_ID.:22:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(7132688625883801337)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6366381801564931576)
,p_branch_action=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16282762391174735)
,p_name=>'P22_CREATED'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16283313563174740)
,p_name=>'P22_IS_OPEN'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1342767015409826417)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1347880874550171741)
,p_name=>'P22_SEVERITY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1420701518042879006)
,p_name=>'P22_FIX_BY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1420701722038882853)
,p_name=>'P22_SINCE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_item_default=>'730'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6366380299990931570)
,p_name=>'P22_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6366380790592931571)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6366540190287741653)
,p_name=>'P22_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6366541787086759618)
,p_name=>'P22_PRIORITY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(6366378574706931565)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(16283178929174739)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(16284171290174749)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(38745394709812726)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1415237320419052608)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16282871651174736)
,p_name=>'Set Created'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16283007101174737)
,p_event_id=>wwv_flow_imp.id(16282871651174736)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16283039837174738)
,p_event_id=>wwv_flow_imp.id(16282871651174736)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16283373252174741)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16283443477174742)
,p_event_id=>wwv_flow_imp.id(16283373252174741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16283728590174744)
,p_event_id=>wwv_flow_imp.id(16283373252174741)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16283912867174746)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16283953250174747)
,p_event_id=>wwv_flow_imp.id(16283912867174746)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16284107458174748)
,p_event_id=>wwv_flow_imp.id(16283912867174746)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(724170010845634168)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1062938758617761737)
,p_event_id=>wwv_flow_imp.id(724170010845634168)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1062938139888761731)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1062938708522761736)
,p_event_id=>wwv_flow_imp.id(724170010845634168)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1062937646106761726)
);
