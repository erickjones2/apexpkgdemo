...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1969781258245021059)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'BUG_NUMBER',
  'attribute_02', 'COLOR',
  'attribute_03', 'PRIMARY_LABEL',
  'attribute_04', 'THE_LINK',
  'attribute_05', 'ATTRIBUTE_01',
  'attribute_06', 'ATTRIBUTE_03',
  'attribute_07', 'ATTRIBUTE_04',
  'attribute_09', 'DESCRIPTION',
  'attribute_12', 'L',
  'attribute_13', 'STATUS')).to_clob
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781409183021060)
,p_name=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781443332021061)
,p_name=>'THE_LINK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781611994021062)
,p_name=>'COLOR'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COLOR'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781719156021063)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781803508021064)
,p_name=>'DESCRIPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969781956533021066)
,p_name=>'ATTRIBUTE_01'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969782423267021070)
,p_name=>'ATTRIBUTE_03'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969782528573021071)
,p_name=>'CREATED'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'CREATED'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969782550534021072)
,p_name=>'ATTRIBUTE_04'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1969782785138021074)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'STATUS'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103815074590336)
,p_name=>'BUG_NUMBER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1969782920413021075)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984102752369590326)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ID'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984102916457590327)
,p_name=>'THE_LINK'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'THE_LINK'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984102981336590328)
,p_name=>'COLOR'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COLOR'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103032632590329)
,p_name=>'PRIMARY_LABEL'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'PRIMARY_LABEL'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103219246590330)
,p_name=>'DESCRIPTION'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'DESCRIPTION'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103303276590331)
,p_name=>'ATTRIBUTE_01'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ATTRIBUTE_01'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103355653590332)
,p_name=>'ATTRIBUTE_03'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ATTRIBUTE_03'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103484905590333)
,p_name=>'CREATED'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'CREATED'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103576140590334)
,p_name=>'ATTRIBUTE_04'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ATTRIBUTE_04'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1984103671789590335)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'STATUS'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3671928954470677951)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3693160342268456003)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1341998593629788077)
,p_name=>'P12_CONTROL_BREAK'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_item_default=>'SEVERITY'
,p_prompt=>'Control Break'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'FILTER REPORT TYPE'
,p_lov=>'.'||wwv_flow_imp.id(1341998686573791771)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1351428346655485886)
,p_name=>'P12_SINCE'
,p_item_sequence=>81
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_item_default=>'365'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3671855446936656855)
,p_name=>'P12_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672046145382694317)
,p_name=>'P12_ASSIGNED'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Assignee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672084333046700171)
,p_name=>'P12_PRODUCT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672126446898704159)
,p_name=>'P12_STATUS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672172037333710882)
,p_name=>'P12_SEVERITY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Severity'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672210737464720346)
,p_name=>'P12_PRIORITY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Priority'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672260531492737579)
,p_name=>'P12_FOUND'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Found'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3672295748808742543)
,p_name=>'P12_FIXED_BY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3671928954470677951)
,p_prompt=>'Fixed By'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1342000107090801568)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1342006698471893911)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1507443655567719527)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512636615160140837)
,p_event_id=>wwv_flow_imp.id(1507443655567719527)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1969781258245021059)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512636684020140838)
,p_event_id=>wwv_flow_imp.id(1507443655567719527)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1969782920413021075)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1507444048027719531)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1507444146887719532)
,p_event_id=>wwv_flow_imp.id(1507444048027719531)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1507444305685719533)
,p_event_id=>wwv_flow_imp.id(1507444048027719531)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1507444412556719534)
,p_event_id=>wwv_flow_imp.id(1507444048027719531)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3693031650186429947)
...
,p_process_when_button_id=>wwv_flow_imp.id(3693160342268456003)
,p_internal_uid=>3693031650186429947
);
