...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1065570951603994495)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1065571029249994495)
,p_name=>'Refresh Log'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065571463138994508)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065571900413994511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065572262400994512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065572723296994512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065573110478994513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065573465523994513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065573860730994514)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065574248558994514)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065574711580994515)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065575116261994515)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1065575435291994516)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(991600199440883436)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1065575868318995246)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3138538588108293241)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1065570951603994495)
,p_button_name=>'RESET'
