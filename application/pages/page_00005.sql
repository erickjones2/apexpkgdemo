...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1096901001654896475)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6325334703700859407)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10371305104607616535)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6332764380040097196)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1096901001654896475)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10371305397468616536)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10371305583314616536)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10371305493689616536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325334994702859408)
,p_name=>'P5_CREATED_BY'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(6325334703700859407)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325335198943859408)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325335378711859408)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325335579948859408)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10371306401076616538)
,p_name=>'P5_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10371305104607616535)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10371306591654616540)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10371306998562616541)
,p_name=>'P5_PARENT_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(10371305104607616535)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10371307202835616541)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10371307395095616541)
,p_name=>'P5_IS_ACTIVE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(10371305104607616535)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10378281387949165071)
,p_name=>'P5_POPUPURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(10371305104607616535)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10378301706565189466)
,p_name=>'P5_REQUEST'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(10371305104607616535)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(6332877180010920443)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(7113493749586863332)
...
,p_associated_item=>wwv_flow_imp.id(10371306591654616540)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10378315087565212343)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103794095143068126)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10371305583314616536)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103794172711068127)
,p_event_id=>wwv_flow_imp.id(1103794095143068126)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10378300301717187977)
...
,p_security_scheme=>wwv_flow_imp.id(3797358846252064904)
,p_internal_uid=>10378300301717187977
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6332766283634107778)
...
,p_security_scheme=>wwv_flow_imp.id(3797358846252064904)
,p_internal_uid=>6332766283634107778
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1103794412637068129)
...
,p_internal_uid=>1103794412637068129
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6332763091684091106)
,p_process_sequence=>30
...
,p_attribute_04=>'ID'
,p_attribute_11=>'I:U:D'
,p_internal_uid=>6332763091684091106
);
