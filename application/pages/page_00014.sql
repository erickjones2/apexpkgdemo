...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1370090418376729237)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'calendar_export', 'CSV',
  'css_class', 'COLOR',
  'display_column', 'BUG_DISPLAY',
  'event_sorting', 'AUTOMATIC',
  'maximum_events_day', '12',
  'multiple_line_event', 'Y',
  'show_time', 'N',
  'show_tooltip', 'Y',
  'show_weekend', 'Y',
  'start_date_column', 'SUBMITTED_ON',
  'supplemental_information', '&BUG_NUMBER. - &SHORT_SUBJECT. - &ACTION.',
  'view_edit_link', 'f?p=&APP_ID.:31:&APP_SESSION.:::31:P31_ID:&ID.')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1407770671269121430)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1408564123706829592)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1407770842098121443)
,p_name=>'P14_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1407770671269121430)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1408561107520805587)
,p_name=>'P14_SHOW'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(1407770671269121430)
,p_item_default=>'0'
...
,p_lov=>'.'||wwv_flow_imp.id(1408561700918814759)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1415237440427064146)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1366273791919497052)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366273892016497053)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366273947621497054)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274080853497055)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274146009497056)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(1370090418376729237)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274304407497057)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274460708497059)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274368705497058)
,p_event_id=>wwv_flow_imp.id(1366273791919497052)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1366274670462497061)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274792420497062)
,p_event_id=>wwv_flow_imp.id(1366274670462497061)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1366274882283497063)
,p_event_id=>wwv_flow_imp.id(1366274670462497061)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
