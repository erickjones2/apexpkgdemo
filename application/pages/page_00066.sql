...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1376751865223166785)
,p_name=>'Search Results'
...
,p_query_row_template=>wwv_flow_imp.id(1225695656427288331)
,p_query_num_rows=>50
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1376760458142197254)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1376761334731211305)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1376761549933215764)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347355080135627)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347488884135628)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347546868135629)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347706543135630)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347826570135631)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1372347919450135632)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4390461347264505760)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4390461731051505761)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4390461347264505760)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4390461528747505760)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(4390463454581505774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390461927438505761)
,p_name=>'P66_ROWS'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_item_default=>'100'
,p_prompt=>'Rows'
,p_source=>'100'
...
,p_named_lov=>'ROWS'
,p_lov=>'.'||wwv_flow_imp.id(4390463542546505775)||'.'
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390462131064505762)
,p_name=>'P66_ASSIGNEE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390462353504505762)
,p_name=>'P66_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390462559829505762)
,p_name=>'P66_STATUS'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390466443319509596)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390474839079527301)
,p_name=>'P66_TAG'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_prompt=>'Tag'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390790229073544914)
,p_name=>'P66_PRODUCT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4390926859425320107)
,p_name=>'P66_PRIORITY'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4392340845029177085)
,p_name=>'P66_SEVERITY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(4390461347264505760)
,p_prompt=>'Severity'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1017377966329077943)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1017378109605077944)
,p_event_id=>wwv_flow_imp.id(1017377966329077943)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1376751865223166785)
);
