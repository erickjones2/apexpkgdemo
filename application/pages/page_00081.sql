...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33565233443636416)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33572639695636424)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(236585747030303959)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(941699109767969856)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(33573743990636427)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(941699109767969856)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(33602248121878809)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(33573407321636427)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(33568319654636420)
,p_name=>'P81_PRODUCT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(33565233443636416)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(33569540225636421)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(941698826520969853)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(991600029530883435)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(991620557083025822)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(991621604931031839)
,p_name=>'P81_OFFSET'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(33565233443636416)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(941698619036969851)
,p_validation_name=>'Product Specified'
,p_validation_sequence=>10
,p_validation=>'P81_PRODUCT'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must be specified.'
,p_when_button_pressed=>wwv_flow_imp.id(33573407321636427)
,p_associated_item=>wwv_flow_imp.id(33568319654636420)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(34605936133652340)
,p_name=>'show working'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(33573407321636427)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(34606330063652342)
,p_event_id=>wwv_flow_imp.id(34605936133652340)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38159040160416853)
,p_name=>'show working for refresh all'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(33602248121878809)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38159498558416873)
,p_event_id=>wwv_flow_imp.id(38159040160416853)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(941699210461969857)
,p_name=>'Cancel Dialog'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(33573743990636427)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(941699293335969858)
,p_event_id=>wwv_flow_imp.id(941699210461969857)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(33574529105636430)
...
,p_process_when_button_id=>wwv_flow_imp.id(33573407321636427)
,p_process_success_message=>'Selected Product (&P81_PRODUCT.) Refreshed'
,p_internal_uid=>33574529105636430
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(33602701284886398)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(33602248121878809)
,p_process_success_message=>'All Product Bugs Refreshed'
,p_internal_uid=>33602701284886398
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(941699356244969859)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>941699356244969859
);
