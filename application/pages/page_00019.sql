...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1096899508453896360)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6325357193358234837)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10379673202481417359)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379674001531417365)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1096899508453896360)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6325363784101288886)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379673783800417365)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10379673592209417363)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325357504098234838)
,p_name=>'P19_CREATED_BY'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_imp.id(6325357193358234837)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325357684336234838)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325357894076234838)
,p_name=>'P19_UPDATED'
,p_item_sequence=>440
,p_item_plug_id=>wwv_flow_imp.id(6325357193358234837)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325358105268234838)
,p_name=>'P19_CREATED'
,p_item_sequence=>420
,p_item_plug_id=>wwv_flow_imp.id(6325357193358234837)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379674602889417366)
,p_name=>'P19_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(10379673202481417359)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379674778197417366)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379675005808417367)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379675206757417367)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379675382557417367)
,p_name=>'P19_REQUEST'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(10379673202481417359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379675597089417367)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379696497362448151)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10383231787767345704)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10383649379230327342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10387021004647537733)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10379675784515417368)
...
,p_associated_item=>wwv_flow_imp.id(10379674778197417366)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10379675984768417370)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(10387112683335768169)
...
,p_when_button_pressed=>wwv_flow_imp.id(10379674001531417365)
,p_associated_item=>wwv_flow_imp.id(10379696497362448151)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1096900253924896468)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10379673783800417365)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1096900420672896469)
,p_event_id=>wwv_flow_imp.id(1096900253924896468)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10379676508069417375)
...
,p_attribute_04=>'10'
,p_process_when_button_id=>wwv_flow_imp.id(10379673592209417363)
,p_internal_uid=>10379676508069417375
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6325365597738302268)
...
,p_internal_uid=>6325365597738302268
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1096900190934896467)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>1096900190934896467
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6325359174920248373)
...
,p_internal_uid=>6325359174920248373
);
