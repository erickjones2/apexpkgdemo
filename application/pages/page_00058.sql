...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1669036909355851780)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(720320576641820470)
,p_region_id=>wwv_flow_imp.id(1669036909355851780)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(720320684636820471)
,p_chart_id=>wwv_flow_imp.id(720320576641820470)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(720320912122820473)
,p_chart_id=>wwv_flow_imp.id(720320576641820470)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(720320778971820472)
,p_chart_id=>wwv_flow_imp.id(720320576641820470)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1669137304379317534)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1669196136335497656)
,p_plug_name=>'Metrics'
