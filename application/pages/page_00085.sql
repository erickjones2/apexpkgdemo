...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(37810771763933523)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(37826919893087453)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(37826952786087453)
,p_name=>'Customers'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37827278457087454)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37827685517087455)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37828125507087455)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37828470002087456)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37828873641087456)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37829259602087457)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(37829646117087457)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(991602444364883459)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(991602611726883460)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(991602721790883461)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(37830054484088426)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(37999379692566809)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(37855604631376207)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(37838797772160197)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(37826919893087453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(37999716614566810)
,p_name=>'P85_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(37999379692566809)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(991172218275751861)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(991172250379751862)
,p_event_id=>wwv_flow_imp.id(991172218275751861)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(37826919893087453)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(991172360936751863)
,p_event_id=>wwv_flow_imp.id(991172218275751861)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1438262979240750269)
,p_name=>'Refresh IRR'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438263080604750270)
,p_event_id=>wwv_flow_imp.id(1438262979240750269)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438263316493750272)
,p_event_id=>wwv_flow_imp.id(1438262979240750269)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438263177080750271)
,p_event_id=>wwv_flow_imp.id(1438262979240750269)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438263366867750273)
,p_event_id=>wwv_flow_imp.id(1438262979240750269)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438263486611750274)
,p_event_id=>wwv_flow_imp.id(1438262979240750269)
,p_event_result=>'FALSE'
