...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5509009688993742934)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(5509009877745742936)
,p_name=>'Severity'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5509009966346742940)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5509010062609742941)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5509010193606742942)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5509010272936742943)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5509242491820800457)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(5509011089648743141)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4564587949996520888)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5509009688993742934)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5509010370606742943)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103932752219443884)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103933135061443884)
,p_event_id=>wwv_flow_imp.id(1103932752219443884)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5509009688993742934)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103795851811068144)
,p_event_id=>wwv_flow_imp.id(1103932752219443884)
,p_event_result=>'TRUE'
