...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1062939815779761747)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1062939859133761748)
,p_region_id=>wwv_flow_imp.id(1062939815779761747)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1062939969004761749)
,p_chart_id=>wwv_flow_imp.id(1062939859133761748)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062940111428761750)
,p_chart_id=>wwv_flow_imp.id(1062939859133761748)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062940188750761751)
,p_chart_id=>wwv_flow_imp.id(1062939859133761748)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1534554893479081793)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1534556685797095722)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1534560821154373428)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534555031519081800)
,p_name=>'P38_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1534554893479081793)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534555610350081805)
,p_name=>'P38_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1534554893479081793)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534555934345081807)
,p_name=>'P38_FIX_BY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1534554893479081793)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1534699226685062526)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1534699256534062527)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376273176049862)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376522983049864)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376394210049863)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(1062939815779761747)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376709124049866)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1062940291296761752)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376805656049867)
,p_event_id=>wwv_flow_imp.id(1534699226685062526)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496376920993049868)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376989054049869)
,p_event_id=>wwv_flow_imp.id(1496376920993049868)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496377064803049870)
,p_event_id=>wwv_flow_imp.id(1496376920993049868)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496377175632049871)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496377265207049872)
,p_event_id=>wwv_flow_imp.id(1496377175632049871)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496377406249049873)
,p_event_id=>wwv_flow_imp.id(1496377175632049871)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
