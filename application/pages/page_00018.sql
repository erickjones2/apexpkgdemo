...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5503072168307537113)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(5503072276609537113)
,p_name=>'Products'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5503072567765537116)
,p_db_column_name=>'ID'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5503072664529537116)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5503072794283537116)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1342805502783011665)
...
,p_heading_alignment=>'LEFT'
,p_rpt_named_lov=>wwv_flow_imp.id(5596221487882515727)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1421118510599962935)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1428197483620673080)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941698255500969848)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(5503074093279545956)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1421118716901967141)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5503072168307537113)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10624368506742970943)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10379474984927079135)
,p_name=>'P18_SOURCEURL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5503072168307537113)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1415238075541073149)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1096899134240896357)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1096899260634896358)
,p_event_id=>wwv_flow_imp.id(1096899134240896357)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5503072168307537113)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1096899410602896359)
,p_event_id=>wwv_flow_imp.id(1096899134240896357)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(314226620416918157)
,p_name=>'Refresh on Edit Product'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5503072168307537113)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(314226663660918158)
,p_event_id=>wwv_flow_imp.id(314226620416918157)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(314226734666918159)
,p_name=>'Refresh on Add Product'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10624368506742970943)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(314226854682918160)
,p_event_id=>wwv_flow_imp.id(314226734666918159)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10379475384751079136)
...
,p_internal_uid=>10379475384751079136
);
