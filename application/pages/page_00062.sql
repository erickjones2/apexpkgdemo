...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4206085237286612385)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4359881929365846949)
,p_plug_name=>'Links'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4359882128266846949)
,p_name=>'Links'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359882239804846951)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359882347637846952)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359882441446846952)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359883027361846954)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359883151133846954)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359884458005891190)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359884529840891190)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359884646810891191)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359884747126891191)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4359901043432010045)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2727482112694686428)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4359883436356847141)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4359883334547846954)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4362741548156545858)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4359881929365846949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4206112344558614525)
,p_name=>'P62_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4206085237286612385)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4359903539154074977)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(4362757249476716518)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103331704767071334)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103332098235071340)
,p_event_id=>wwv_flow_imp.id(1103331704767071334)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4359881929365846949)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103332618732071341)
,p_event_id=>wwv_flow_imp.id(1103331704767071334)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4359903659933080987)
...
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>4359903659933080987
);
