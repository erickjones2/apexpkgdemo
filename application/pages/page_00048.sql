...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1420830491323340880)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308634069096508990)
,p_plug_name=>'Bug'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308825095436623557)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308831471588645037)
,p_plug_name=>'Flex'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1225690169574288324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308831680592647700)
,p_plug_name=>'Audit'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1225690169574288324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308831889249650138)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6308634598218508990)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6308634488076508990)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6308634383864508990)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6308634292435508990)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2726647557762445374)
,p_branch_name=>'On Delete'
,p_branch_action=>'f?p=&APP_ID.:23:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(6308634488076508990)
,p_branch_sequence=>5
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6308635288778508992)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1436678107643561449)
,p_name=>'P48_CUSTOMER'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(6308831889249650138)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2151222954611974066)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4526694637083182401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5497218583175402521)
,p_name=>'P48_NEW_PRODUCT'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(6308634069096508990)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5503560676207758647)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5505089991025524236)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308635490390508992)
,p_name=>'P48_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6308634069096508990)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308635677054509002)
,p_name=>'P48_SUBJECT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(6308634069096508990)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308636081449509018)
,p_name=>'P48_SUBMITTED_ON'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(6308831680592647700)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308636287123509019)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308636496191509019)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308636674807509019)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308636878146509021)
,p_name=>'P48_DESCRIPTION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(6308825095436623557)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308637076464509022)
,p_name=>'P48_OS_NAME'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(6308831889249650138)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308637284414509023)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308637490755509023)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308637692779509023)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308637867161509024)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308638090215509024)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308638267192509025)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308638486977509025)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308638896335509026)
,p_name=>'P48_FLEX_01'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(6308831471588645037)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Flex 01'
,p_source=>'FLEX_01'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308639073310509027)
,p_name=>'P48_FLEX_02'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(6308831471588645037)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308639280126509027)
,p_name=>'P48_FLEX_03'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_imp.id(6308831471588645037)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308639482289509027)
,p_name=>'P48_FLEX_04'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(6308831471588645037)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308639690276509028)
,p_name=>'P48_FLEX_05'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(6308831471588645037)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308639888342509028)
,p_name=>'P48_CREATED'
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_imp.id(6308831680592647700)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308640095102509029)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308640289432509029)
,p_name=>'P48_UPDATED'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_imp.id(6308831680592647700)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308640488789509030)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6308640681078509030)
,p_name=>'P48_TAGS'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(6308831889249650138)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2714603037334693098)
...
,p_associated_item=>wwv_flow_imp.id(6308635677054509002)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2714603745301704562)
...
,p_associated_item=>wwv_flow_imp.id(5497218583175402521)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2151223319364974069)
...
,p_validation_condition2=>'0'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_imp.id(2151222954611974066)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(5497218871532408658)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5497219193740408665)
,p_event_id=>wwv_flow_imp.id(5497218871532408658)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(5497219375531408670)
,p_event_id=>wwv_flow_imp.id(5497218871532408658)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2151223050202974067)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2151223184646974068)
,p_event_id=>wwv_flow_imp.id(2151223050202974067)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2151223484974974071)
,p_event_id=>wwv_flow_imp.id(2151223050202974067)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6308640882060509031)
...
,p_internal_uid=>6308640882060509031
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5497219889240442138)
...
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>5497219889240442138
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2151223358103974070)
...
,p_process_clob_language=>'PLSQL'
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>2151223358103974070
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6308641082870509031)
...
,p_security_scheme=>wwv_flow_imp.id(3797424040496072790)
,p_internal_uid=>6308641082870509031
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6308641270269509032)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_imp.id(6308634488076508990)
,p_internal_uid=>6308641270269509032
);
