...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3462103159348766904)
,p_plug_name=>'Users'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3462103335703766905)
,p_name=>'Users'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3462103428175766907)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3462103532342766908)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3462103848701766908)
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(3462242028703774365)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3462103631714766908)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3462103727632766908)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2534268652577490842)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941696935478969835)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697091600969836)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697147049969837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697265150969838)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697398910969839)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697516578969840)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(941697614513969841)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3462103930562766909)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2534491348947855103)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3462103159348766904)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2622530845909042673)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3462104142392766912)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2704155831930546134)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103797035844068156)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103797225851068157)
,p_event_id=>wwv_flow_imp.id(1103797035844068156)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3462103159348766904)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103797323088068158)
,p_event_id=>wwv_flow_imp.id(1103797035844068156)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(332494020762100129)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3462104142392766912)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(332494093863100130)
,p_event_id=>wwv_flow_imp.id(332494020762100129)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(332494211229100131)
,p_name=>'Refresh on Bulk Add'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2622530845909042673)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(332494235381100132)
,p_event_id=>wwv_flow_imp.id(332494211229100131)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(332494355802100133)
,p_name=>'Refresh on Edit'
,p_event_sequence=>40
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3462103159348766904)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(332494464052100134)
,p_event_id=>wwv_flow_imp.id(332494355802100133)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
