...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6308614766619347617)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(6308614885053347617)
,p_name=>'Statuses'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6308615066947347618)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6308615170014347619)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6308615274068347619)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(6308861668151871179)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5499830066022927127)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4102326438343387753)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1322447010155005762)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1322447040455005764)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(991599186668883426)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1507635482502885428)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1507635553555885429)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(6308615490944347907)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6337636700092966782)
,p_plug_name=>'Notes'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4564587156314503808)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(6308614766619347617)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10623652699388587372)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(10623652892708587376)
,p_branch_action=>'f?p=&FLOW_ID.:9:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(10623652699388587372)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6363838586517572152)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(6364409805356429737)
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:RP,13::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(6364408698646418349)
,p_branch_sequence=>30
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'Created 06-SEP-2007 05:02 by SATHISH'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10318360500193152431)
,p_name=>'P13_SOURCEURL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6308614766619347617)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1415239269545082773)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(946140736622127534)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(946140908676127535)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103794829455068134)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103795026182068135)
,p_event_id=>wwv_flow_imp.id(1103794829455068134)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6308614766619347617)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6363839090673573319)
...
,p_internal_uid=>6363839090673573319
);
