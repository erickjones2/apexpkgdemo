...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1096900524094896470)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10841125003199469264)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10841125402786469266)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1096900524094896470)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10841125206797469266)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(10841126579533469270)
,p_branch_action=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::P17_ID:&P19_PRODUCT_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(10841125402786469266)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10841125589740469266)
,p_name=>'P47_DELETE_ERROR'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(10841125003199469264)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10841125795970469268)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10841126001255469269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10841126203730469269)
,p_name=>'P47_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(10841125003199469264)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10841126406947469269)
...
,p_process_when_button_id=>wwv_flow_imp.id(10841125402786469266)
,p_process_success_message=>'Version Succesfully Deleted.'
,p_internal_uid=>10841126406947469269
);
