...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4101704933439282232)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4101705057032282246)
,p_name=>'Notifications'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705258273282246)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705350286282246)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705431185282246)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705531168282246)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705659900282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705745470282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705855562282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101705928270282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101706042055282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101706132097282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101706241702282247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4101706332691282247)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4101725036556283117)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2671441456777141593)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4101704933439282232)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4101513651385264464)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1103796330252068149)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1103796518569068150)
,p_event_id=>wwv_flow_imp.id(1103796330252068149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4101704933439282232)
);
